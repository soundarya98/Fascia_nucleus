...
extern char wfSSID[20];
extern char wfPASS[20];
...
void Data_Steam(Sensors_Data * data, DataPacket *packet, uint8_t pkgNumber,uint8_t idx, uint8_t period);
