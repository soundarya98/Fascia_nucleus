...
// -------------- Print Sensory Voltage Output ---------------------------------- //
void print_AnalogSensors(void){

    Serial.print("Ground Sense: "); 
    uint16_t Val = get_AnalogSense_Level(GND_ref_pin);
    float a = calc_Sensory_Output(Val, VDD);
    Serial.print(a,4);
    Serial.print("V\t");
   
    Serial.print("VDD Sense: "); 
    uint16_t Val1 = get_AnalogSense_Level(VDD_ref_pin);
    float b = calc_Sensory_Output(Val1, VDD);
    Serial.print(b,4);
    Serial.print("V\t");
  
    Serial.print("Battery Level: "); 
    uint16_t Val2 = get_AnalogSense_Level(BATT_Sense_pin);
    float c = calc_Sensory_Output(Val2, BATTVOLT);
    Serial.print(c,4);
    Serial.print("V\t"); 
    
    Serial.print("EDA Level: "); 
    uint16_t Val3 = get_AnalogSense_Level(EDA_Sense_pin);
    float d = calc_Sensory_Output(Val3, VDD);
    Serial.print(d,4); 
    Serial.println("V");
