...
sleep_edf_data_dir = '/home/fascia/Fascia_nucleus/Fascia_modelZoo/SleepEDF/physionet.org/files/sleep-edfx/1.0.0/sleep-cassette'

psg_fnames = glob.glob(os.path.join(sleep_edf_data_dir, "*PSG.edf"))
ann_fnames = glob.glob(os.path.join(sleep_edf_data_dir, "*Hypnogram.edf"))
psg_fnames.sort()
ann_fnames.sort()
...
def edf_header(f):
  ...
  h['date_time'] = str(datetime(year + 2000, month, day,
    hour, minute, sec))
...
for i in range(len(psg_fnames)):
    if psg_fnames[i] == '/home/fascia/Fascia_nucleus/Fascia_modelZoo/SleepEDF/physionet.org/files/sleep-edfx/1.0.0/sleep-cassette/SC4362F0-PSG.edf':
        continue
    ...
    # print(raw.to_data_frame(scaling_time=100.0))
